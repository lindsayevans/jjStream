...
export const WEATHER_URL =
  'https://api.open-meteo.com/v1/forecast?latitude=-33.88782587331829&longitude=151.17536428068186&current=temperature_2m,apparent_temperature,is_day,weather_code&forecast_days=1';
